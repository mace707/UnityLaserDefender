...
public class StringConstants : MonoBehaviour 
{
	...
	public const string SCENEWin = "Win Screen";

	public const string TEXTSpawnCount 	= "SpawnCountText";
	...
	public const string UITEXT_HitPoints 	= "HPDisplayText"; 
	public const string UIIMAGE_HitPoints 	= "HPBarForeground";

	public const string UITEXT_ShieldPoints 	= "SPDisplayText"; 
	public const string UIIMAGE_ShieldPoints 	= "SPBarForeground";

	public const string UITEXT_FocusPoints 	= "FPDisplayText"; 
	public const string UIIMAGE_FocusPoints	= "FPBarForeground";
